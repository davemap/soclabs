export const referenceDesigns = [
  {
    ...
    blockDiagram: [
      ...
      { name: "Extension Port", type: "interface", techId: "hw-acceleration", gateCount: "~0.2K", info: "An exposed AHB-Lite slave port allowing users to attach custom accelerators or additional peripherals. Provides address, data, and control signals with a standardised handshake for easy IP integration." },
    ],
