...
export const communityProjects = [
  {
    ...
    milestones: [
      ...
      { phase: "architecture", task: "Design memory map", done: true, effort: 2, uncertainty: 2, startDate: "2025-03-20", projectedEndDate: "2025-04-05", completedDate: "2025-04-03", assigneeId: "sarah-chen", blurb: "Allocate address ranges for MAC array registers, weight buffer, activation config, and status/control." },
      { phase: "architecture", task: "Define accelerator interface spec", done: true, effort: 3, uncertainty: 3, startDate: "2025-04-01", projectedEndDate: "2025-04-20", completedDate: "2025-04-25", assigneeId: "kenji-tanaka", blurb: "Specify the AHB slave interface for the accelerator including register map, interrupt lines, and DMA request signals." },
      { phase: "rtl", task: "Implement 8×8 MAC array", done: true, effort: 4, uncertainty: 3, startDate: "2025-04-25", projectedEndDate: "2025-05-30", completedDate: "2025-05-28", assigneeId: "sarah-chen", blurb: "Design systolic array with configurable precision. Implement weight loading, partial sum accumulation, and output staging." },
      { phase: "rtl", task: "Implement weight buffer with DMA", done: true, effort: 3, uncertainty: 2, startDate: "2025-05-15", projectedEndDate: "2025-06-15", completedDate: "2025-06-10", assigneeId: "kenji-tanaka", blurb: "Double-buffered weight memory with DMA-driven loading from main SRAM. Supports pre-fetching for next layer." },
      { phase: "rtl", task: "Implement activation pipeline", done: true, effort: 3, uncertainty: 2, startDate: "2025-06-01", projectedEndDate: "2025-06-25", completedDate: "2025-06-22", assigneeId: "sarah-chen", blurb: "Pipelined activation functions (ReLU, sigmoid, tanh) with LUT-based approximation for non-linear functions." },
      { phase: "rtl", task: "Implement control FSM", done: true, effort: 4, uncertainty: 3, startDate: "2025-06-20", projectedEndDate: "2025-07-20", completedDate: "2025-07-18", assigneeId: "sarah-chen", blurb: "Master FSM that sequences layer execution, manages DMA transfers, and handles interrupt generation on completion." },
      { phase: "verification", task: "Unit tests for MAC array", done: true, effort: 3, uncertainty: 2, startDate: "2025-07-01", projectedEndDate: "2025-07-25", completedDate: "2025-07-20", assigneeId: "kenji-tanaka", blurb: "Directed and constrained-random tests for the MAC array covering overflow, underflow, and precision edge cases." },
      { phase: "verification", task: "Integration testbench", done: true, effort: 4, uncertainty: 3, startDate: "2025-07-20", projectedEndDate: "2025-08-20", completedDate: "2025-08-18", assigneeId: "kenji-tanaka", blurb: "Full SoC testbench with Cortex-M0 running firmware that configures and triggers the accelerator via memory-mapped registers." },
      { phase: "verification", task: "Functional coverage > 95%", done: true, effort: 4, uncertainty: 3, startDate: "2025-08-15", projectedEndDate: "2025-09-15", completedDate: "2025-09-12", assigneeId: "kenji-tanaka", blurb: "Cover all register access patterns, DMA transfer sizes, activation modes, and interrupt scenarios." },
      { phase: "synthesis", task: "Logic synthesis with timing constraints", done: true, effort: 3, uncertainty: 2, startDate: "2025-09-10", projectedEndDate: "2025-09-30", completedDate: "2025-09-28", assigneeId: "sarah-chen", blurb: "Synthesise for 100 MHz target. Resolve timing violations in MAC array critical paths." },
      { phase: "synthesis", task: "Area and power analysis", done: true, effort: 2, uncertainty: 1, startDate: "2025-09-25", projectedEndDate: "2025-10-10", completedDate: "2025-10-08", assigneeId: "sarah-chen", blurb: "Generate area and power reports. MAC array uses ~3,200 LUTs. Dynamic power within budget." },
      { phase: "synthesis", task: "FPGA prototype on Arty A7", done: true, effort: 3, uncertainty: 2, startDate: "2025-10-05", projectedEndDate: "2025-10-25", completedDate: "2025-10-22", assigneeId: "sarah-chen", blurb: "FPGA-specific synthesis, place & route, and bitstream generation for the Digilent Arty A7-35T board." },
      { phase: "synthesis", task: "Run inference benchmark on hardware", done: false, effort: 3, uncertainty: 3, startDate: "2025-10-20", projectedEndDate: "2025-11-15", assigneeId: "kenji-tanaka", blurb: "Execute MobileNet-v1 inference on real hardware and measure latency, throughput, and power consumption." },
      { phase: "synthesis", task: "Optimise clock frequency", done: false, effort: 4, uncertainty: 4, startDate: "2025-11-10", projectedEndDate: "2025-12-10", assigneeId: "sarah-chen", blurb: "Push clock frequency beyond 100 MHz through pipeline balancing and critical path optimisation." },
      { phase: "physical-design", task: "Physical design flow", done: false, effort: 5, uncertainty: 4, startDate: "2026-02-15", projectedEndDate: "2026-04-15", assigneeId: "sarah-chen", blurb: "Complete physical design including floorplanning, placement, clock tree synthesis, routing, and sign-off checks." },
      { phase: "tapeout", task: "Select shuttle service", done: false, effort: 2, uncertainty: 3, startDate: "2026-01-10", projectedEndDate: "2026-02-10", assigneeId: "sarah-chen", blurb: "Evaluate Europractice, MOSIS, and Google/Skywater shuttles for cost, turnaround, and technology node." },
      { phase: "silicon-validation", task: "Post-silicon bring-up", done: false, effort: 4, uncertainty: 5, startDate: "2026-07-01", projectedEndDate: "2026-08-30", assigneeId: "kenji-tanaka", blurb: "Power-on testing, JTAG connectivity, clock verification, and basic peripheral bring-up on fabricated silicon." },
    ],
  },
  {
    id: "crypto-engine",
    ...
    milestones: [
      ...
      { phase: "rtl", task: "Implement AES core", done: true, effort: 5, uncertainty: 2, startDate: "2025-02-15", projectedEndDate: "2025-04-01", completedDate: "2025-03-28", assigneeId: "james-okonkwo", blurb: "Iterative AES architecture with shared S-Box. Supports both 128 and 256-bit key lengths." },
      { phase: "rtl", task: "Implement SHA-256 engine", done: true, effort: 4, uncertainty: 2, startDate: "2025-03-20", projectedEndDate: "2025-04-25", completedDate: "2025-04-22", assigneeId: "james-okonkwo", blurb: "SHA-256 message digest engine with padding logic and 64-round compression function." },
      { phase: "rtl", task: "Implement key scheduler", done: true, effort: 3, uncertainty: 2, startDate: "2025-04-15", projectedEndDate: "2025-05-10", completedDate: "2025-05-08", assigneeId: "james-okonkwo", blurb: "On-the-fly key expansion avoiding full round-key storage. Supports both AES key lengths." },
      { phase: "verification", task: "AES known-answer tests", done: true, effort: 3, uncertainty: 1, startDate: "2025-05-05", projectedEndDate: "2025-05-25", completedDate: "2025-05-20", assigneeId: "james-okonkwo", blurb: "Validate against NIST FIPS 197 test vectors for all key lengths and block modes." },
      { phase: "verification", task: "SHA-256 test vectors", done: true, effort: 2, uncertainty: 1, startDate: "2025-05-15", projectedEndDate: "2025-06-01", completedDate: "2025-05-28", assigneeId: "james-okonkwo", blurb: "Verify against NIST SHA-256 test vectors including multi-block messages and edge cases." },
      { phase: "verification", task: "DMA integration tests", done: true, effort: 3, uncertainty: 2, startDate: "2025-05-25", projectedEndDate: "2025-06-15", completedDate: "2025-06-12", assigneeId: "james-okonkwo", blurb: "Test bulk data transfers via DMA with various buffer sizes and alignment scenarios." },
      { phase: "synthesis", task: "Synthesis for TSMC 65nm", done: true, effort: 4, uncertainty: 3, startDate: "2025-06-10", projectedEndDate: "2025-07-10", completedDate: "2025-07-08", assigneeId: "james-okonkwo", blurb: "Logic synthesis targeting TSMC 65nm standard cells with 100 MHz timing constraint." },
      { phase: "synthesis", task: "Timing closure", done: true, effort: 3, uncertainty: 2, startDate: "2025-07-05", projectedEndDate: "2025-07-25", completedDate: "2025-07-22", assigneeId: "james-okonkwo", blurb: "Static timing analysis across all corners. Fix setup/hold violations in S-Box paths." },
      { phase: "synthesis", task: "FPGA prototype validation", done: true, effort: 3, uncertainty: 2, startDate: "2025-07-20", projectedEndDate: "2025-08-15", completedDate: "2025-08-10", assigneeId: "james-okonkwo", blurb: "Validate crypto engine functionality on FPGA before committing to tapeout." },
      { phase: "physical-design", task: "Floorplanning, placement & routing", done: true, effort: 5, uncertainty: 3, startDate: "2025-08-10", projectedEndDate: "2025-09-20", completedDate: "2025-09-18", assigneeId: "james-okonkwo", blurb: "Floorplanning, placement, CTS, and routing for TSMC 65nm. Target area under 15 kGE." },
      { phase: "physical-design", task: "DRC/LVS sign-off", done: true, effort: 3, uncertainty: 2, startDate: "2025-09-15", projectedEndDate: "2025-10-05", completedDate: "2025-10-02", assigneeId: "james-okonkwo", blurb: "Pass all design rule checks and layout-vs-schematic verification for foundry submission." },
      { phase: "tapeout", task: "Submit to Europractice shuttle", done: false, effort: 2, uncertainty: 3, startDate: "2025-10-01", projectedEndDate: "2025-10-30", assigneeId: "james-okonkwo", blurb: "Prepare GDS-II, submit to Europractice MPW shuttle, and handle foundry interface requirements." },
      { phase: "silicon-validation", task: "Receive silicon samples", done: false, effort: 1, uncertainty: 4, startDate: "2026-03-01", projectedEndDate: "2026-04-01", assigneeId: "james-okonkwo", blurb: "Receive packaged dies from Europractice, inspect packaging, and prepare test boards." },
      { phase: "silicon-validation", task: "Post-silicon validation", done: false, effort: 4, uncertainty: 5, startDate: "2026-04-01", projectedEndDate: "2026-06-01", assigneeId: "james-okonkwo", blurb: "Full functional and performance validation of fabricated crypto engine against pre-silicon simulations." },
    ],
  },
  {
    id: "dsp-filter",
    ...
    milestones: [
      ...
      { phase: "rtl", task: "Implement shared MAC units", done: true, effort: 4, uncertainty: 2, startDate: "2025-03-05", projectedEndDate: "2025-04-10", completedDate: "2025-04-08", assigneeId: "maria-gonzalez", blurb: "Four 16×16 multiply-accumulate blocks with time-division multiplexing across all channels." },
      { phase: "rtl", task: "Implement coefficient RAM", done: true, effort: 3, uncertainty: 1, startDate: "2025-04-05", projectedEndDate: "2025-04-25", completedDate: "2025-04-20", assigneeId: "maria-gonzalez", blurb: "2 KB dual-port coefficient memory mapped to AHB address space for runtime updates." },
      { phase: "rtl", task: "Implement IIR path", done: false, effort: 4, uncertainty: 3, startDate: "2025-04-20", projectedEndDate: "2025-05-25", assigneeId: "maria-gonzalez", blurb: "Add IIR filter topology with feedback paths and stability checks for up to 8th-order filters." },
      { phase: "verification", task: "FIR path unit tests", done: true, effort: 3, uncertainty: 2, startDate: "2025-04-15", projectedEndDate: "2025-05-10", completedDate: "2025-05-05", assigneeId: "maria-gonzalez", blurb: "Test FIR filters against MATLAB golden reference for various filter orders and coefficient sets." },
      { phase: "verification", task: "Multi-channel integration test", done: false, effort: 4, uncertainty: 3, startDate: "2025-05-20", projectedEndDate: "2025-06-20", assigneeId: "maria-gonzalez", blurb: "Verify all 8 channels operating simultaneously with independent filter configurations." },
      { phase: "synthesis", task: "FIR path running on Arty A7", done: true, effort: 3, uncertainty: 2, startDate: "2025-05-01", projectedEndDate: "2025-05-20", completedDate: "2025-05-18", assigneeId: "maria-gonzalez", blurb: "Deploy FIR-only configuration to Arty A7 FPGA and validate with real audio input signals." },
      { phase: "synthesis", task: "Full filter bank synthesis & FPGA deployment", done: false, effort: 3, uncertainty: 3, startDate: "2025-06-15", projectedEndDate: "2025-07-15", assigneeId: "maria-gonzalez", blurb: "Complete synthesis with both FIR and IIR paths, all 8 channels, and runtime reconfiguration." },
    ],
  },
  {
    ...
    milestones: [
      ...
      { phase: "rtl", task: "Integrate PicoRV32 core", done: true, effort: 3, uncertainty: 2, startDate: "2025-06-15", projectedEndDate: "2025-07-15", completedDate: "2025-07-10", assigneeId: "kenji-tanaka", blurb: "Instantiate and configure PicoRV32 RV32I core with AHB-Lite wrapper for bus integration." },
      { phase: "rtl", task: "Implement bus arbiter", done: true, effort: 4, uncertainty: 3, startDate: "2025-07-10", projectedEndDate: "2025-08-10", completedDate: "2025-08-15", assigneeId: "kenji-tanaka", blurb: "Custom arbiter handling simultaneous requests from ARM and RISC-V cores with fair scheduling." },
      { phase: "rtl", task: "Implement hardware mailbox", done: false, effort: 3, uncertainty: 3, startDate: "2025-08-10", projectedEndDate: "2025-09-10", assigneeId: "sarah-chen", blurb: "Hardware FIFO-based mailbox for inter-processor communication with interrupt generation." },
      { phase: "verification", task: "Dual-core boot test", done: true, effort: 3, uncertainty: 3, startDate: "2025-08-01", projectedEndDate: "2025-08-25", completedDate: "2025-08-22", assigneeId: "kenji-tanaka", blurb: "Verify both cores boot independently and can execute code from shared SRAM." },
      { phase: "verification", task: "Mailbox IPC tests", done: false, effort: 3, uncertainty: 4, startDate: "2025-09-15", projectedEndDate: "2025-10-15", assigneeId: "sarah-chen", blurb: "Test message passing between cores via mailbox with concurrent access and overflow scenarios." },
      { phase: "synthesis", task: "Basic dual-core on FPGA", done: true, effort: 3, uncertainty: 3, startDate: "2025-09-01", projectedEndDate: "2025-09-30", completedDate: "2025-10-05", assigneeId: "kenji-tanaka", blurb: "Deploy dual-core system to Arty A7-35T and verify basic operation of both processors." },
      { phase: "synthesis", task: "Runtime task partitioning", done: false, effort: 4, uncertainty: 4, startDate: "2025-10-10", projectedEndDate: "2025-11-30", assigneeId: "kenji-tanaka", blurb: "Implement simple runtime that dynamically partitions workload between ARM and RISC-V cores." },
    ],
  },
  {
    id: "power-management",
    ...
    milestones: [
      ...
      { phase: "architecture", task: "Plan activity monitor counters", done: false, effort: 2, uncertainty: 3, startDate: "2026-01-10", projectedEndDate: "2026-02-10", assigneeId: "emily-watson", blurb: "Select performance counters (IPC, cache miss rate, bus utilisation) and define sampling strategy." },
      { phase: "rtl", task: "Implement policy engine", done: false, effort: 4, uncertainty: 3, startDate: "2026-02-15", projectedEndDate: "2026-03-30", assigneeId: "emily-watson", blurb: "LUT-based decision logic mapping activity profiles to optimal voltage/frequency operating points." },
      { phase: "rtl", task: "Implement clock manager", done: false, effort: 4, uncertainty: 3, startDate: "2026-03-15", projectedEndDate: "2026-04-30", assigneeId: "emily-watson", blurb: "Glitch-free clock switching with programmable divider ratios and smooth transition logic." },
      { phase: "rtl", task: "Implement voltage controller SPI", done: false, effort: 3, uncertainty: 2, startDate: "2026-04-15", projectedEndDate: "2026-05-15", assigneeId: "emily-watson", blurb: "SPI master interface for controlling external PMIC voltage regulators with sequencing logic." },
    ],
  },
];
