...
export const communityProjects = [
  {
    ...
    milestones: [
      { phase: "architecture", task: "Define system partitioning", done: true },
      { phase: "architecture", task: "Select bus architecture (AHB-Lite)", done: true },
      { phase: "architecture", task: "Design memory map", done: true },
      { phase: "architecture", task: "Define accelerator interface spec", done: true },
      { phase: "rtl", task: "Implement 8×8 MAC array", done: true },
      { phase: "rtl", task: "Implement weight buffer with DMA", done: true },
      { phase: "rtl", task: "Implement activation pipeline", done: true },
      { phase: "rtl", task: "Implement control FSM", done: true },
      { phase: "verification", task: "Unit tests for MAC array", done: true },
      { phase: "verification", task: "Integration testbench", done: true },
      { phase: "verification", task: "Functional coverage > 95%", done: true },
      { phase: "synthesis", task: "Logic synthesis with timing constraints", done: true },
      { phase: "synthesis", task: "Area and power analysis", done: true },
      { phase: "fpga", task: "Synthesise for Arty A7", done: true },
      { phase: "fpga", task: "Run inference benchmark on hardware", done: false },
      { phase: "fpga", task: "Optimise clock frequency", done: false },
      { phase: "asic", task: "Select shuttle service", done: false },
      { phase: "asic", task: "Physical design flow", done: false },
      { phase: "silicon-validation", task: "Post-silicon bring-up", done: false },
    ],
  },
  {
    id: "crypto-engine",
    ...
    milestones: [
      { phase: "architecture", task: "Define crypto engine spec", done: true },
      { phase: "architecture", task: "Plan shared datapath", done: true },
      { phase: "rtl", task: "Implement AES core", done: true },
      { phase: "rtl", task: "Implement SHA-256 engine", done: true },
      { phase: "rtl", task: "Implement key scheduler", done: true },
      { phase: "verification", task: "AES known-answer tests", done: true },
      { phase: "verification", task: "SHA-256 test vectors", done: true },
      { phase: "verification", task: "DMA integration tests", done: true },
      { phase: "synthesis", task: "Synthesis for TSMC 65nm", done: true },
      { phase: "synthesis", task: "Timing sign-off", done: true },
      { phase: "fpga", task: "FPGA prototype validation", done: true },
      { phase: "asic", task: "Physical design complete", done: true },
      { phase: "asic", task: "DRC/LVS sign-off", done: true },
      { phase: "asic", task: "Submit to Europractice shuttle", done: false },
      { phase: "silicon-validation", task: "Receive silicon samples", done: false },
      { phase: "silicon-validation", task: "Post-silicon validation", done: false },
    ],
  },
  {
    id: "dsp-filter",
    ...
    milestones: [
      { phase: "architecture", task: "Define filter bank architecture", done: true },
      { phase: "architecture", task: "Specify channel sequencer", done: true },
      { phase: "rtl", task: "Implement shared MAC units", done: true },
      { phase: "rtl", task: "Implement coefficient RAM", done: true },
      { phase: "rtl", task: "Implement IIR path", done: false },
      { phase: "verification", task: "FIR path unit tests", done: true },
      { phase: "verification", task: "Multi-channel integration test", done: false },
      { phase: "fpga", task: "FIR path running on Arty A7", done: true },
      { phase: "fpga", task: "Full filter bank on FPGA", done: false },
    ],
  },
  {
    ...
    milestones: [
      { phase: "architecture", task: "Define dual-core architecture", done: true },
      { phase: "architecture", task: "Design bus arbitration scheme", done: true },
      { phase: "rtl", task: "Integrate PicoRV32 core", done: true },
      { phase: "rtl", task: "Implement bus arbiter", done: true },
      { phase: "rtl", task: "Implement hardware mailbox", done: false },
      { phase: "verification", task: "Dual-core boot test", done: true },
      { phase: "verification", task: "Mailbox IPC tests", done: false },
      { phase: "fpga", task: "Basic dual-core on FPGA", done: true },
      { phase: "fpga", task: "Runtime task partitioning", done: false },
    ],
  },
  {
    id: "power-management",
    ...
    milestones: [
      { phase: "architecture", task: "Write PMU specification", done: true },
      { phase: "architecture", task: "Define DVFS operating points", done: false },
      { phase: "architecture", task: "Plan activity monitor counters", done: false },
      { phase: "rtl", task: "Implement policy engine", done: false },
      { phase: "rtl", task: "Implement clock manager", done: false },
      { phase: "rtl", task: "Implement voltage controller SPI", done: false },
    ],
  },
];
