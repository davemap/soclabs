export const referenceDesigns = [
  {
    ...
    moduleHierarchy: [
      { name: "Chip Pads", type: "group", description: "The outermost physical layer of the chip — the I/O pad ring that connects the silicon die to the package pins. Each pad includes ESD protection, level shifting, and configurable drive strength.", children: [
        ...
        { name: "GPIO[2]", type: "module", description: "General-purpose I/O pad, directly bonded to package pin.", techId: "standard-peripherals" },
        { name: "GPIO[3]", type: "module", description: "General-purpose I/O pad with interrupt capability on rising/falling edge.", techId: "standard-peripherals" },
        { name: "VSS", type: "module", description: "Core ground pad. Paired with VDD for low-impedance return path." },
        { name: "UART_TX", type: "module", description: "UART transmit pad with ESD protection. Active during serial communication.", techId: "standard-peripherals" },
        { name: "UART_RX", type: "module", description: "UART receive pad with ESD protection and input buffer.", techId: "standard-peripherals" },
        { name: "GPIO[4]", type: "module", description: "General-purpose I/O pad.", techId: "standard-peripherals" },
        { name: "GPIO[5]", type: "module", description: "General-purpose I/O pad.", techId: "standard-peripherals" },
        { name: "VDD_IO", type: "module", description: "I/O power supply pad (3.3 V) for level-shifting I/O ring." },
        ...
        { name: "SWDIO", type: "module", description: "Serial Wire Debug data I/O pad (active during debug sessions).", techId: "standard-peripherals" },
        { name: "GPIO[6]", type: "module", description: "General-purpose I/O pad.", techId: "standard-peripherals" },
        { name: "GPIO[7]", type: "module", description: "General-purpose I/O pad.", techId: "standard-peripherals" },
        { name: "VSS_IO", type: "module", description: "I/O ground pad, paired with VDD_IO." },
        { name: "CLK_IN", type: "module", description: "Crystal oscillator or external clock input pad feeding on-chip clock generation." },
        { name: "RESETn", type: "module", description: "Active-low system reset input with internal synchroniser and glitch filter." },
        { name: "GPIO[8]", type: "module", description: "General-purpose I/O pad.", techId: "standard-peripherals" },
        { name: "GPIO[9]", type: "module", description: "General-purpose I/O pad.", techId: "standard-peripherals" },
        { name: "VDD", type: "module", description: "Second core power supply pad for reduced ground bounce." },
        { name: "GPIO[10]", type: "module", description: "General-purpose I/O pad.", techId: "standard-peripherals" },
        { name: "GPIO[11]", type: "module", description: "General-purpose I/O pad.", techId: "standard-peripherals" },
        { name: "VSS", type: "module", description: "Second core ground pad." },
      ]},
