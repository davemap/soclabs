export const referenceDesigns = [
  {
    ...
    blockDiagram: [
      ...
      { name: "Expansion Region", type: "interface", techId: "hw-acceleration", gateCount: "~0.2K", info: "An exposed AHB-Lite slave port allowing users to attach custom accelerators or additional peripherals. Provides address, data, and control signals with a standardised handshake for easy IP integration." },
    ],
