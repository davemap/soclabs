export const referenceDesigns = [
  {
    ...
    blockDiagram: [
      { name: "CPU Subsystem", type: "subsystem", gateCount: "~14K", info: "The CPU Subsystem encapsulates the ARM Cortex-M0 processor with its tightly-coupled instruction and data memories. This grouping reflects the physical design hierarchy where the processor and its local memories form a single clock-domain unit on the AHB-Lite bus.", configOptions: ["Cortex-M0 (default — minimal gate count)", "Cortex-M0+ (optional — improved performance, +2K gates)"], subBlocks: [
      ...
      { name: "Expansion Subsystem", type: "subsystem", techId: "hw-acceleration", gateCount: "~0.7K", info: "An expandable region on the AHB-Lite bus providing SRAM storage and a slot for custom accelerators. Users can attach their own IP blocks here without modifying the core interconnect.", subBlocks: [
