export const referenceDesigns = [
  {
    ...
    blockDiagram: [
      { name: "CPU Subsystem", type: "subsystem", icon: "processor", gateCount: "~14K", info: "The CPU Subsystem encapsulates the ARM Cortex-M0 processor with its tightly-coupled instruction and data memories. This grouping reflects the physical design hierarchy where the processor and its local memories form a single clock-domain unit on the AHB-Lite bus.", configOptions: ["Cortex-M0 (default — minimal gate count)", "Cortex-M0+ (optional — improved performance, +2K gates)"], subBlocks: [
        { name: "ARM Cortex-M0", type: "processor", techId: "arm-cortex-m0", gateCount: "~12K", info: "The ARM Cortex-M0 is the smallest ARM processor, optimised for ultra-low gate count and minimal power. In NanoSoC it runs at up to 50 MHz with a single-cycle multiplier, providing a 0.9 DMIPS/MHz performance profile ideal for embedded control tasks." },
        { name: "Instruction Memory", type: "memory", techId: "memory-controllers", gateCount: "~0.5K (controller)", info: "Tightly-coupled instruction ROM/RAM providing single-cycle fetch for the Cortex-M0. Mapped at 0x00000000 in the ARM memory map for vector table and boot code." },
        { name: "Data Memory", type: "memory", techId: "memory-controllers", gateCount: "~0.5K (controller)", info: "Tightly-coupled data SRAM providing single-cycle read/write access for stack, heap, and global variables. Mapped at 0x20000000 in the ARM memory map." },
      ...
      { name: "Watchdog", type: "peripheral", techId: "standard-peripherals", gateCount: "~0.3K", info: "32-bit watchdog timer with lock register to prevent accidental disable. Generates system reset if not serviced within the programmed timeout window, ensuring firmware liveness." },
      { name: "Debug Controller", type: "debug", external: true, techId: "standard-peripherals", gateCount: "~2K", info: "ARM CoreSight-compatible Serial Wire Debug (SWD) interface providing non-intrusive debug access. Supports breakpoints, watchpoints, and memory access via an external debug probe (e.g. CMSIS-DAP).", configOptions: ["SWD only (default)", "SWD + JTAG (optional, +0.5K gates)"] },
      { name: "Expansion Subsystem", type: "subsystem", icon: "interface", techId: "hw-acceleration", gateCount: "~0.7K", info: "An expandable region on the AHB-Lite bus providing SRAM storage and a slot for custom accelerators. Users can attach their own IP blocks here without modifying the core interconnect.", subBlocks: [
        ...
        { name: "Custom Accelerator", type: "interface", userDesigned: true, techId: "hw-acceleration", gateCount: "User-defined", info: "A user-defined hardware accelerator slot connected via the AHB-Lite slave interface. This is where students and researchers integrate their own custom IP — such as DSP filters, ML inference engines, or crypto blocks." }
      ] },
    ],
    moduleHierarchy: [
      { name: "nanosoc_chip_pads", type: "group", description: "The outermost physical layer — the I/O pad ring connecting the silicon die to package pins. Active pads are grouped into Port 0 (P0[15:0]) and Port 1 (P1[15:0]) GPIO banks, plus dedicated SWD, power, and clock/reset pads.", children: [
        ...
        { name: "SWDCLK", type: "module", description: "Serial Wire Debug clock input pad for external debug probe.", techId: "standard-peripherals" },
        { name: "CLK_IN", type: "module", description: "System clock input pad — feeds PLL or direct clock path to nanosoc_chip.", },
        { name: "nRST", type: "module", description: "Active-low system reset input pad (SYS_SYSRESETn) with glitch filter.", },
        { name: "VDD", type: "module", description: "Core power supply pads (1.2 V / 1.8 V). Multiple VDD pads reduce IR drop across the die." },
        { name: "VSS", type: "module", description: "Core ground pads. Paired with VDD for low-impedance return path." },
        { name: "VDDACC", type: "module", description: "Accelerator power domain supply pad (conditionally included via POWER_PINS)." },
        { name: "SCAN/BIST", type: "module", description: "DFT pads: scan_mode, scan_enable, scan_in[3:0], scan_out[3:0], bist_mode, bist_enable, bist_in[3:0], bist_out[3:0], diag_mode, diag_ctrl." },
        { name: "ALT_MODE", type: "module", description: "Alternate mode pad — selects UART mode for debug port. Also uart_rxd_i / uart_txd_o pads." },
      ]},
      { name: "nanosoc_chip", type: "group", description: "Top-level chip module (nanosoc_chip.v). Instantiates clock/reset wiring, SWD pad routing, GPIO pad-to-port mapping, and the nanosoc_system SoC core. Targeted for FPGA synthesis or ASIC tapeout.", techId: "system-integration", children: [
        { name: "nanosoc_system", type: "group", description: "The SoC system integration level (nanosoc_system.v). Instantiates all subsystems, memory regions, bus matrix, and performs interrupt/DMA/IO wiring. Defines the complete memory map and interrupt topology.", children: [
          { name: "nanosoc_ss_cpu", type: "group", description: "CPU Subsystem (u_ss_cpu). Contains the ARM Cortex-M0 processor with clock/reset generation (PORESETn, HCLK, HRESETn), SWD debug port, and AHB-Lite master interface. Also routes boot ROM, IMEM, and DMEM AHB slave ports.", techId: "arm-cortex-m0", children: [
            { name: "CORTEXM0", type: "module", description: "ARM Cortex-M0 processor core — ~12K gates, 0.9 DMIPS/MHz, 3-stage pipeline, single-cycle multiplier. Configurable: NUMIRQ=32, BKPT=4, WPT=2, WIC support.", techId: "arm-cortex-m0" },
            { name: "cmsdk_mcu_clkctrl", type: "module", description: "Clock and reset controller — generates SYS_FCLK, SYS_HCLK, SYS_HRESETn, SYS_PORESETn from external clock and reset inputs. Handles SYSRESETREQ, debug reset, and watchdog reset." },
            { name: "bootrom_0", type: "module", description: "Boot ROM region (nanosoc_region_bootrom_0) — parameterised address width (default 2KB). Holds initial boot sequence and vector table at reset vector address.", techId: "memory-controllers" },
            { name: "imem_0", type: "module", description: "Instruction Memory region (nanosoc_region_imem_0) — single-cycle SRAM, default 16KB. Mapped at 0x00000000. Can be preloaded with firmware image.", techId: "memory-controllers" },
            { name: "dmem_0", type: "module", description: "Data Memory region (nanosoc_region_dmem_0) — single-cycle SRAM, default 16KB. Mapped at 0x20000000 for stack, heap, and globals.", techId: "memory-controllers" },
          ]},
          { name: "nanosoc_ss_dma", type: "group", description: "DMA Subsystem (u_ss_dma). Contains two DMA controllers with AHB-Lite master ports and APB configuration ports. DMAC_0 handles expansion region transfers, DMAC_1 is available for additional channels.", techId: "amba-interconnect", children: [
            { name: "DMAC_0 (PL230)", type: "module", description: "DMA Controller 0 — 4-channel DMA (PL230 or DMA-350). Channels 0-1 for expansion region DRQ, channels 2-3 for EXTIO data stream DMA requests. AHB master + APB config.", techId: "amba-interconnect" },
            { name: "DMAC_1 (PL230)", type: "module", description: "DMA Controller 1 — 2-channel DMA. Secondary controller for additional autonomous transfers. AHB master + APB config.", techId: "amba-interconnect" },
          ]},
          { name: "nanosoc_ss_debug", type: "group", description: "Debug Subsystem (u_ss_debug). SoC-level debug access via ADP (ARM Debug Processor) with AHB-Lite master for memory access, GPIO interface (GPO8/GPI8), and AXI-Stream byte interfaces for ADP/STDIN/STDOUT.", techId: "standard-peripherals", children: [
            ...
            { name: "socdebug_usrt_control", type: "module", description: "USRT Controller (u_usrt_control). APB-mapped serial controller bridging ADP STDIN/STDOUT streams. Configurable baud rate divider, TX/RX FIFOs, interrupt support." },
            { name: "socdebug_ft1248_control", type: "module", description: "FT1248 Controller (u_ft1248_control). FTDI FT1248 serial interface for host PC communication via USB. Supports 1/2/4-bit width, configurable clock divider." },
          ]},
          { name: "nanosoc_ss_systemctrl", type: "group", description: "System Control Subsystem (u_ss_systemctrl). Contains the APB peripheral bus, AHB-to-APB bridge, GPIO controllers, timer, watchdog, UART, and system ROM table. Generates APB clocks (PCLK, PCLKG) and peripheral resets.", techId: "standard-peripherals", children: [
            { name: "AHB-to-APB Bridge", type: "module", description: "Converts AHB transactions to APB protocol. Generates SYSIO_PENABLE, PWRITE, PADDR, PWDATA driving signals for all APB peripherals.", techId: "apb" },
            { name: "GPIO Port 0", type: "module", description: "16-bit GPIO with configurable direction, alternate function muxing, interrupt generation on rising/falling edges, and pull resistor control. Directly mapped to P0 pads.", techId: "standard-peripherals" },
            { name: "GPIO Port 1", type: "module", description: "16-bit GPIO with output mux (SYS_P1_OUT_MUX) for FT1248/EXTIO mode switching. Lower pins conditionally routed to FT1248 or EXTIO8x4 interface.", techId: "standard-peripherals" },
            { name: "UART", type: "module", description: "Full-duplex UART with FIFOs, configurable baud rate, and interrupt support. APB-mapped peripheral.", techId: "standard-peripherals" },
            { name: "Timer", type: "module", description: "Dual-channel 32-bit timer/counter with prescaler, auto-reload, and interrupt generation.", techId: "standard-peripherals" },
            { name: "Watchdog", type: "module", description: "32-bit watchdog with lock register. Generates SYS_WDOGRESETREQ if firmware fails to service within timeout.", techId: "standard-peripherals" },
            { name: "systable", type: "module", description: "System ROM Table (nanosoc_region_systable). CoreSight ROM table at 0xF0000000 with SoC identification: JEPID=0x51 (SoCLabs), part number, revision.", techId: "standard-peripherals" },
          ]},
          { name: "nanosoc_ss_interconnect", type: "group", description: "Interconnect Subsystem (u_ss_interconnect). Multi-master AHB bus matrix connecting 3 masters (CPU, DMAC_0, DMAC_1, Debug) to 8 slave regions. Address decoder with REMAP support for boot remapping.", techId: "ahb-lite", children: [
            { name: "nanosoc_busmatrix", type: "module", description: "Generated AHB bus matrix — arbitrates between CPU_0, DMAC_0, DMAC_1, and DEBUG master ports. Routes to BOOTROM_0, IMEM_0, DMEM_0, SYSIO, EXPRAM_L, EXPRAM_H, EXP, and SYSTABLE slave regions.", techId: "ahb-lite" },
            { name: "Address Decoder", type: "module", description: "Parameterised address decoder with SYS_REMAP_CTRL[3:0] support. REMAP bit swaps BOOTROM_0 and IMEM_0 mapping for post-boot operation.", techId: "ahb-lite" },
            { name: "Default Slave", type: "module", description: "Returns HRESP error for accesses to unmapped address regions, preventing bus hangs.", techId: "ahb-lite" },
          ]},
          { name: "nanosoc_ss_expansion", type: "group", description: "Expansion Subsystem (u_ss_expansion). User-extensible region with AHB slave port, two SRAM banks (low + high), and DMA/interrupt connections. Optionally supports DMA-350 AXI-Stream channels.", techId: "hw-acceleration", children: [
            { name: "expram_l", type: "module", description: "Expansion SRAM Low (nanosoc_region_expram_l) — default 16KB single-cycle SRAM. Serves as scratchpad or additional program memory for accelerators.", techId: "memory-controllers" },
            { name: "expram_h", type: "module", description: "Expansion SRAM High (nanosoc_region_expram_h) — default 16KB single-cycle SRAM. Second SRAM bank for double-buffering or larger data sets.", techId: "memory-controllers" },
            { name: "accelerator_subsystem", type: "module", userDesigned: true, description: "User-defined accelerator subsystem (system/src/accelerator_subsystem.v). AHB slave + DMA request/done signals + CPU interrupt lines. Integrate your custom IP here.", techId: "hw-acceleration" },
          ]},
  ...
  },
  {
    id: "millisoc",
    name: "milliSoC",
    tagline: "Production-ready Cortex-M7 SoC with rich peripheral set",
    description:
      "A more feature-rich SoC targeting real-world applications. Built around the ARM Cortex-M7 with a multi-layer AHB bus matrix, DMA controller, SPI, I2C, and an extensible accelerator interface. Suitable for tapeout via available ASIC shuttle services.",
    features: [
      "ARM Cortex-M7 core",
    ...
    githubUrl: "https://github.com/soclabs/millisoc",
    docsUrl: "https://docs.soclabs.org/millisoc",
    image: "/placeholder.svg",
    ...
    blockDiagram: [
      ...
      { name: "SPI", type: "peripheral", techId: "standard-peripherals", gateCount: "~2K", info: "SPI master/slave controller with configurable clock polarity/phase, up to 50 MHz clock, and 8-entry TX/RX FIFOs. Supports DMA for high-throughput data streaming to external flash or sensors.", configOptions: ["PL022 SPI (default)", "Quad-SPI with XIP (optional, +3K gates)"] },
      { name: "I2C", type: "peripheral", techId: "standard-peripherals", gateCount: "~1.2K", info: "I²C master controller supporting standard (100 kHz), fast (400 kHz), and fast-plus (1 MHz) modes. Includes clock stretching, multi-master arbitration, and 10-bit addressing." },
      { name: "Timer", type: "peripheral", techId: "standard-peripherals", gateCount: "~1K", info: "Four 32-bit timer/counter channels with PWM output, input capture, and output compare modes. Supports chained operation for 64-bit timing and DMA trigger generation.", configOptions: ["Dual-channel", "Quad-channel (default)", "Octal-channel (+1K gates)"] },
      { name: "RTC", type: "peripheral", techId: "standard-peripherals", gateCount: "~0.5K", info: "Real-time clock with 32.768 kHz crystal oscillator input, calendar function, and programmable alarm. Operates in low-power standby and generates wake-up interrupts." },
      { name: "Accelerator Slot", type: "interface", techId: "hw-acceleration", gateCount: "~0.3K (wrapper)", info: "Standardised AHB slave interface slot with interrupt and DMA request lines for integrating custom hardware accelerators. Includes a template wrapper with register interface for rapid IP onboarding." },
    ],
    relatedTechnologies: ["ARM Cortex-M3", "Design Compiler / Genus", "Vivado / Quartus", "UVM / cocotb"],
    developmentProjectId: "millisoc-dev",
    version: "2.0.1",
    branch: "main",
    provenIn: [
  ...
  },
  {
    ...
    blockDiagram: [
      ...
      { name: "SPI", type: "peripheral", techId: "standard-peripherals", gateCount: "~4K", info: "Quad-SPI controller with XIP support for external flash, dual/quad I/O modes, and DMA integration. Supports clock rates up to 100 MHz for high-bandwidth external memory access.", configOptions: ["PL022 standard SPI", "Quad-SPI with XIP (default)"] },
      { name: "I2C", type: "peripheral", techId: "standard-peripherals", gateCount: "~1.5K", info: "I²C master/slave controller with high-speed mode (3.4 MHz), bus clear recovery, and SMBus/PMBus compatibility. Supports device management for sensor hubs." },
      { name: "Timer", type: "peripheral", techId: "standard-peripherals", gateCount: "~2K", info: "Eight 32-bit timer channels with advanced PWM, dead-time insertion, and encoder interface modes. Supports motor control and precision timing applications.", configOptions: ["Quad-channel", "Octal-channel (default)"] },
      { name: "RTC", type: "peripheral", techId: "standard-peripherals", gateCount: "~0.8K", info: "Real-time clock with tamper detection, timestamp capture, and battery-backed operation. Includes calibration register for crystal frequency trimming." },
      { name: "Accelerator Slot", type: "interface", techId: "hw-acceleration", gateCount: "~0.5K (wrapper)", info: "Standardised AHB slave interface with interrupt, DMA request, and coherency signals for custom hardware accelerators. Includes reference wrapper with AXI-to-AHB bridge option." },
    ],
...
export const communityProjects = [
  {
    ...
    milestones: [
      {
        phase: "architecture",
        task: "Define system partitioning",
        done: true,
        effort: 3,
        uncertainty: 2,
        ...
        blurb:
          "Break the system into processor, accelerator, and peripheral subsystems. Define interfaces and data flow between partitions.",
        learningTopicIds: ["system-partitioning"],
      },
      {
        phase: "architecture",
        task: "Select bus architecture (AHB-Lite)",
        done: true,
        effort: 2,
        uncertainty: 1,
        startDate: "2025-03-10",
        projectedEndDate: "2025-03-25",
        completedDate: "2025-03-22",
        assigneeId: "sarah-chen",
        blurb:
          "Evaluate AHB-Lite vs AXI for the extension port. AHB-Lite chosen for simplicity given single-master topology.",
        learningTopicIds: ["bus-architecture"],
      },
      {
        phase: "architecture",
        ...
        projectedEndDate: "2025-04-05",
        completedDate: "2025-04-03",
        assigneeId: "sarah-chen",
        blurb: "Allocate address ranges for MAC array registers, weight buffer, activation config, and status/control.",
        learningTopicIds: ["memory-map"],
      },
      {
        phase: "architecture",
        task: "Define accelerator interface spec",
        done: true,
        effort: 3,
        uncertainty: 3,
        startDate: "2025-04-01",
        projectedEndDate: "2025-04-20",
        completedDate: "2025-04-25",
        assigneeId: "kenji-tanaka",
        blurb:
          "Specify the AHB slave interface for the accelerator including register map, interrupt lines, and DMA request signals.",
        learningTopicIds: ["interface-protocols", "ip-selection"],
      },
      {
        phase: "rtl",
        task: "Implement 8×8 MAC array",
        done: true,
        effort: 4,
        uncertainty: 3,
        startDate: "2025-04-25",
        projectedEndDate: "2025-05-30",
        completedDate: "2025-05-28",
        assigneeId: "sarah-chen",
        blurb:
          "Design systolic array with configurable precision. Implement weight loading, partial sum accumulation, and output staging.",
        learningTopicIds: ["coding-style", "parameterisation"],
      },
      {
        phase: "rtl",
        task: "Implement weight buffer with DMA",
        done: true,
        effort: 3,
        uncertainty: 2,
        startDate: "2025-05-15",
        projectedEndDate: "2025-06-15",
        completedDate: "2025-06-10",
        assigneeId: "kenji-tanaka",
        blurb:
          "Double-buffered weight memory with DMA-driven loading from main SRAM. Supports pre-fetching for next layer.",
        learningTopicIds: ["interface-protocols", "coding-style"],
      },
      {
        phase: "rtl",
        task: "Implement activation pipeline",
        done: true,
        effort: 3,
        uncertainty: 2,
        startDate: "2025-06-01",
        projectedEndDate: "2025-06-25",
        completedDate: "2025-06-22",
        assigneeId: "sarah-chen",
        blurb:
          "Pipelined activation functions (ReLU, sigmoid, tanh) with LUT-based approximation for non-linear functions.",
        learningTopicIds: ["coding-style", "parameterisation"],
      },
      {
        phase: "rtl",
        task: "Implement control FSM",
        done: true,
        effort: 4,
        uncertainty: 3,
        startDate: "2025-06-20",
        projectedEndDate: "2025-07-20",
        completedDate: "2025-07-18",
        assigneeId: "sarah-chen",
        blurb:
          "Master FSM that sequences layer execution, manages DMA transfers, and handles interrupt generation on completion.",
        learningTopicIds: ["fsm-design"],
      },
      {
        phase: "verification",
        task: "Unit tests for MAC array",
        done: true,
        effort: 3,
        uncertainty: 2,
        startDate: "2025-07-01",
        projectedEndDate: "2025-07-25",
        completedDate: "2025-07-20",
        assigneeId: "kenji-tanaka",
        blurb:
          "Directed and constrained-random tests for the MAC array covering overflow, underflow, and precision edge cases.",
        learningTopicIds: ["testbench-architecture", "constrained-random"],
      },
      {
        phase: "verification",
        task: "Integration testbench",
        done: true,
        effort: 4,
        uncertainty: 3,
        startDate: "2025-07-20",
        projectedEndDate: "2025-08-20",
        completedDate: "2025-08-18",
        assigneeId: "kenji-tanaka",
        blurb:
          "Full SoC testbench with Cortex-M0 running firmware that configures and triggers the accelerator via memory-mapped registers.",
        learningTopicIds: ["testbench-architecture", "regression-ci"],
      },
      {
        phase: "verification",
        task: "Functional coverage > 95%",
        done: true,
        effort: 4,
        uncertainty: 3,
        ...
        assigneeId: "kenji-tanaka",
        blurb: "Cover all register access patterns, DMA transfer sizes, activation modes, and interrupt scenarios.",
        learningTopicIds: ["functional-coverage"],
      },
      {
        phase: "synthesis",
        task: "Logic synthesis with timing constraints",
        done: true,
        effort: 3,
        uncertainty: 2,
        startDate: "2025-09-10",
        projectedEndDate: "2025-09-30",
        completedDate: "2025-09-28",
        assigneeId: "sarah-chen",
        blurb: "Synthesise for 100 MHz target. Resolve timing violations in MAC array critical paths.",
        learningTopicIds: ["constraints", "synthesis-strategies"],
      },
      {
        phase: "synthesis",
        task: "Area and power analysis",
        done: true,
        effort: 2,
        uncertainty: 1,
        startDate: "2025-09-25",
        projectedEndDate: "2025-10-10",
        completedDate: "2025-10-08",
        assigneeId: "sarah-chen",
        blurb: "Generate area and power reports. MAC array uses ~3,200 LUTs. Dynamic power within budget.",
        learningTopicIds: ["synthesis-strategies"],
      },
      {
        phase: "synthesis",
        task: "FPGA prototype on Arty A7",
        done: true,
        effort: 3,
        uncertainty: 2,
        startDate: "2025-10-05",
        projectedEndDate: "2025-10-25",
        completedDate: "2025-10-22",
        assigneeId: "sarah-chen",
        blurb: "FPGA-specific synthesis, place & route, and bitstream generation for the Digilent Arty A7-35T board.",
        learningTopicIds: ["synthesis-strategies"],
      },
      {
        phase: "synthesis",
        task: "Run inference benchmark on hardware",
        done: false,
        effort: 3,
        uncertainty: 3,
        startDate: "2025-10-20",
        projectedEndDate: "2025-11-15",
        assigneeId: "kenji-tanaka",
        blurb:
          "Execute MobileNet-v1 inference on real hardware and measure latency, throughput, and power consumption.",
        learningTopicIds: ["synthesis-strategies"],
      },
      {
        phase: "synthesis",
        task: "Optimise clock frequency",
        done: false,
        effort: 4,
        uncertainty: 4,
        startDate: "2025-11-10",
        projectedEndDate: "2025-12-10",
        assigneeId: "sarah-chen",
        blurb: "Push clock frequency beyond 100 MHz through pipeline balancing and critical path optimisation.",
        learningTopicIds: ["timing-closure"],
      },
      {
        phase: "physical-design",
        task: "Physical design flow",
        done: false,
        effort: 5,
        uncertainty: 4,
        ...
        assigneeId: "sarah-chen",
        blurb:
          "Complete physical design including floorplanning, placement, clock tree synthesis, routing, and sign-off checks.",
        learningTopicIds: ["floorplanning", "placement", "clock-tree", "routing"],
      },
      {
        phase: "tapeout",
        task: "Select shuttle service",
        done: false,
        effort: 2,
        uncertainty: 3,
        ...
        assigneeId: "sarah-chen",
        blurb: "Evaluate Europractice, MOSIS, and Google/Skywater shuttles for cost, turnaround, and technology node.",
        learningTopicIds: ["shuttle-submission"],
      },
      {
        phase: "silicon-validation",
        task: "Post-silicon bring-up",
        done: false,
        effort: 4,
        uncertainty: 5,
        ...
        assigneeId: "kenji-tanaka",
        blurb:
          "Power-on testing, JTAG connectivity, clock verification, and basic peripheral bring-up on fabricated silicon.",
        learningTopicIds: ["bring-up", "functional-test"],
      },
    ],
  },
  {
    ...
    description:
      "An AES-128/256 and SHA-256 hardware accelerator designed for IoT security applications. Integrated into the milliSoC accelerator slot with minimal area overhead.",
    architecture:
      "Pipelined AES core with configurable key length. SHA-256 engine shares the datapath for area efficiency.",
    tags: ["Cryptography", "Security", "milliSoC", "ASIC"],
    referenceSoc: "milliSoC",
    technology: "ASIC",
    status: "Completed",
    ...
    milestones: [
      {
        phase: "architecture",
        task: "Define crypto engine spec",
        done: true,
        effort: 3,
        uncertainty: 2,
        startDate: "2025-01-10",
        projectedEndDate: "2025-02-01",
        completedDate: "2025-01-28",
        assigneeId: "james-okonkwo",
        blurb:
          "Write detailed specification for AES and SHA-256 engines including key sizes, modes, and throughput targets.",
        learningTopicIds: ["system-partitioning", "ip-selection"],
      },
      {
        phase: "architecture",
        task: "Plan shared datapath",
        done: true,
        effort: 4,
        uncertainty: 3,
        startDate: "2025-01-25",
        projectedEndDate: "2025-02-20",
        completedDate: "2025-02-18",
        assigneeId: "james-okonkwo",
        blurb: "Design time-division multiplexed datapath shared between AES and SHA-256 to minimise area.",
        learningTopicIds: ["system-partitioning"],
      },
      {
        phase: "rtl",
        task: "Implement AES core",
        done: true,
        effort: 5,
        uncertainty: 2,
        startDate: "2025-02-15",
        projectedEndDate: "2025-04-01",
        completedDate: "2025-03-28",
        assigneeId: "james-okonkwo",
        blurb: "Iterative AES architecture with shared S-Box. Supports both 128 and 256-bit key lengths.",
        learningTopicIds: ["coding-style", "parameterisation"],
      },
      {
        phase: "rtl",
        task: "Implement SHA-256 engine",
        done: true,
        effort: 4,
        uncertainty: 2,
        startDate: "2025-03-20",
        projectedEndDate: "2025-04-25",
        completedDate: "2025-04-22",
        assigneeId: "james-okonkwo",
        blurb: "SHA-256 message digest engine with padding logic and 64-round compression function.",
        learningTopicIds: ["coding-style"],
      },
      {
        phase: "rtl",
        task: "Implement key scheduler",
        done: true,
        effort: 3,
        uncertainty: 2,
        startDate: "2025-04-15",
        projectedEndDate: "2025-05-10",
        completedDate: "2025-05-08",
        assigneeId: "james-okonkwo",
        blurb: "On-the-fly key expansion avoiding full round-key storage. Supports both AES key lengths.",
        learningTopicIds: ["fsm-design", "coding-style"],
      },
      {
        phase: "verification",
        task: "AES known-answer tests",
        done: true,
        effort: 3,
        uncertainty: 1,
        startDate: "2025-05-05",
        projectedEndDate: "2025-05-25",
        completedDate: "2025-05-20",
        assigneeId: "james-okonkwo",
        blurb: "Validate against NIST FIPS 197 test vectors for all key lengths and block modes.",
        learningTopicIds: ["testbench-architecture"],
      },
      {
        phase: "verification",
        task: "SHA-256 test vectors",
        done: true,
        effort: 2,
        uncertainty: 1,
        startDate: "2025-05-15",
        projectedEndDate: "2025-06-01",
        completedDate: "2025-05-28",
        assigneeId: "james-okonkwo",
        blurb: "Verify against NIST SHA-256 test vectors including multi-block messages and edge cases.",
        learningTopicIds: ["testbench-architecture"],
      },
      {
        phase: "verification",
        task: "DMA integration tests",
        done: true,
        effort: 3,
        uncertainty: 2,
        ...
        assigneeId: "james-okonkwo",
        blurb: "Test bulk data transfers via DMA with various buffer sizes and alignment scenarios.",
        learningTopicIds: ["testbench-architecture", "regression-ci"],
      },
      {
        phase: "synthesis",
        task: "Synthesis for TSMC 65nm",
        done: true,
        effort: 4,
        uncertainty: 3,
        startDate: "2025-06-10",
        projectedEndDate: "2025-07-10",
        completedDate: "2025-07-08",
        assigneeId: "james-okonkwo",
        blurb: "Logic synthesis targeting TSMC 65nm standard cells with 100 MHz timing constraint.",
        learningTopicIds: ["constraints", "synthesis-strategies"],
      },
      {
        phase: "synthesis",
        ...
        assigneeId: "james-okonkwo",
        blurb: "Static timing analysis across all corners. Fix setup/hold violations in S-Box paths.",
        learningTopicIds: ["timing-closure"],
      },
      {
        phase: "synthesis",
        task: "FPGA prototype validation",
        done: true,
        effort: 3,
        uncertainty: 2,
        startDate: "2025-07-20",
        projectedEndDate: "2025-08-15",
        completedDate: "2025-08-10",
        assigneeId: "james-okonkwo",
        blurb: "Validate crypto engine functionality on FPGA before committing to tapeout.",
        learningTopicIds: ["synthesis-strategies"],
      },
      {
        phase: "physical-design",
        task: "Floorplanning, placement & routing",
        done: true,
        effort: 5,
        uncertainty: 3,
        startDate: "2025-08-10",
        projectedEndDate: "2025-09-20",
        completedDate: "2025-09-18",
        assigneeId: "james-okonkwo",
        blurb: "Floorplanning, placement, CTS, and routing for TSMC 65nm. Target area under 15 kGE.",
        learningTopicIds: ["floorplanning", "placement", "routing"],
      },
      {
        phase: "physical-design",
        task: "DRC/LVS sign-off",
        done: true,
        effort: 3,
        uncertainty: 2,
        startDate: "2025-09-15",
        projectedEndDate: "2025-10-05",
        completedDate: "2025-10-02",
        assigneeId: "james-okonkwo",
        blurb: "Pass all design rule checks and layout-vs-schematic verification for foundry submission.",
        learningTopicIds: ["signoff-checks"],
      },
      {
        phase: "tapeout",
        task: "Submit to Europractice shuttle",
        done: false,
        effort: 2,
        uncertainty: 3,
        startDate: "2025-10-01",
        projectedEndDate: "2025-10-30",
        assigneeId: "james-okonkwo",
        blurb: "Prepare GDS-II, submit to Europractice MPW shuttle, and handle foundry interface requirements.",
        learningTopicIds: ["shuttle-submission"],
      },
      {
        phase: "silicon-validation",
        task: "Receive silicon samples",
        done: false,
        effort: 1,
        uncertainty: 4,
        ...
        assigneeId: "james-okonkwo",
        blurb: "Receive packaged dies from Europractice, inspect packaging, and prepare test boards.",
        learningTopicIds: ["bring-up"],
      },
      {
        phase: "silicon-validation",
        task: "Post-silicon validation",
        done: false,
        effort: 4,
        uncertainty: 5,
        ...
        assigneeId: "james-okonkwo",
        blurb:
          "Full functional and performance validation of fabricated crypto engine against pre-silicon simulations.",
        learningTopicIds: ["functional-test", "characterisation"],
      },
    ],
  },
  {
    ...
    milestones: [
      {
        phase: "architecture",
        task: "Define filter bank architecture",
        done: true,
        effort: 3,
        uncertainty: 2,
        startDate: "2025-02-01",
        projectedEndDate: "2025-02-25",
        completedDate: "2025-02-22",
        assigneeId: "maria-gonzalez",
        blurb: "Specify filter topology, channel count, and MAC sharing strategy for area-efficient implementation.",
        learningTopicIds: ["system-partitioning", "ip-selection"],
      },
      {
        phase: "architecture",
        task: "Specify channel sequencer",
        done: true,
        effort: 2,
        uncertainty: 2,
        startDate: "2025-02-20",
        projectedEndDate: "2025-03-10",
        completedDate: "2025-03-08",
        assigneeId: "maria-gonzalez",
        blurb: "Design round-robin scheduling for 8 channels with deterministic latency guarantees.",
        learningTopicIds: ["system-partitioning"],
      },
      {
        phase: "rtl",
        task: "Implement shared MAC units",
        done: true,
        effort: 4,
        uncertainty: 2,
        startDate: "2025-03-05",
        projectedEndDate: "2025-04-10",
        completedDate: "2025-04-08",
        assigneeId: "maria-gonzalez",
        blurb: "Four 16×16 multiply-accumulate blocks with time-division multiplexing across all channels.",
        learningTopicIds: ["coding-style", "parameterisation"],
      },
      {
        phase: "rtl",
        task: "Implement coefficient RAM",
        done: true,
        effort: 3,
        uncertainty: 1,
        ...
        assigneeId: "maria-gonzalez",
        blurb: "2 KB dual-port coefficient memory mapped to AHB address space for runtime updates.",
        learningTopicIds: ["coding-style", "interface-protocols"],
      },
      {
        phase: "rtl",
        task: "Implement IIR path",
        done: false,
        effort: 4,
        uncertainty: 3,
        ...
        projectedEndDate: "2025-05-25",
        assigneeId: "maria-gonzalez",
        blurb: "Add IIR filter topology with feedback paths and stability checks for up to 8th-order filters.",
        learningTopicIds: ["coding-style", "fsm-design"],
      },
      {
        phase: "verification",
        task: "FIR path unit tests",
        done: true,
        effort: 3,
        uncertainty: 2,
        startDate: "2025-04-15",
        ...
        assigneeId: "maria-gonzalez",
        blurb: "Test FIR filters against MATLAB golden reference for various filter orders and coefficient sets.",
        learningTopicIds: ["testbench-architecture"],
      },
      {
        phase: "verification",
        task: "Multi-channel integration test",
        done: false,
        effort: 4,
        uncertainty: 3,
        startDate: "2025-05-20",
        projectedEndDate: "2025-06-20",
        assigneeId: "maria-gonzalez",
        blurb: "Verify all 8 channels operating simultaneously with independent filter configurations.",
        learningTopicIds: ["testbench-architecture", "functional-coverage"],
      },
      {
        phase: "synthesis",
        task: "FIR path running on Arty A7",
        done: true,
        effort: 3,
        uncertainty: 2,
        startDate: "2025-05-01",
        projectedEndDate: "2025-05-20",
        completedDate: "2025-05-18",
        assigneeId: "maria-gonzalez",
        blurb: "Deploy FIR-only configuration to Arty A7 FPGA and validate with real audio input signals.",
        learningTopicIds: ["synthesis-strategies"],
      },
      {
        phase: "synthesis",
        task: "Full filter bank synthesis & FPGA deployment",
        done: false,
        effort: 3,
        uncertainty: 3,
        ...
        assigneeId: "maria-gonzalez",
        blurb: "Complete synthesis with both FIR and IIR paths, all 8 channels, and runtime reconfiguration.",
        learningTopicIds: ["constraints", "synthesis-strategies"],
      },
    ],
  },
  {
    ...
    milestones: [
      {
        phase: "architecture",
        task: "Define dual-core architecture",
        done: true,
        effort: 4,
        uncertainty: 4,
        startDate: "2025-05-01",
        ...
        completedDate: "2025-05-28",
        assigneeId: "kenji-tanaka",
        blurb: "Design heterogeneous dual-core topology with shared memory and independent reset/clock domains.",
        learningTopicIds: ["system-partitioning", "power-clocking"],
      },
      {
        phase: "architecture",
        task: "Design bus arbitration scheme",
        done: true,
        effort: 3,
        uncertainty: 3,
        startDate: "2025-05-25",
        ...
        assigneeId: "kenji-tanaka",
        blurb: "Round-robin arbiter with priority override for the AHB-Lite bus supporting both cores.",
        learningTopicIds: ["bus-architecture"],
      },
      {
        phase: "rtl",
        task: "Integrate PicoRV32 core",
        done: true,
        effort: 3,
        uncertainty: 2,
        startDate: "2025-06-15",
        ...
        assigneeId: "kenji-tanaka",
        blurb: "Instantiate and configure PicoRV32 RV32I core with AHB-Lite wrapper for bus integration.",
        learningTopicIds: ["ip-selection", "interface-protocols"],
      },
      {
        phase: "rtl",
        task: "Implement bus arbiter",
        done: true,
        effort: 4,
        uncertainty: 3,
        startDate: "2025-07-10",
        projectedEndDate: "2025-08-10",
        completedDate: "2025-08-15",
        assigneeId: "kenji-tanaka",
        blurb: "Custom arbiter handling simultaneous requests from ARM and RISC-V cores with fair scheduling.",
        learningTopicIds: ["fsm-design", "interface-protocols"],
      },
      {
        phase: "rtl",
        task: "Implement hardware mailbox",
        done: false,
        effort: 3,
        uncertainty: 3,
        startDate: "2025-08-10",
        projectedEndDate: "2025-09-10",
        assigneeId: "sarah-chen",
        blurb: "Hardware FIFO-based mailbox for inter-processor communication with interrupt generation.",
        learningTopicIds: ["coding-style", "fsm-design"],
      },
      {
        phase: "verification",
        task: "Dual-core boot test",
        done: true,
        effort: 3,
        uncertainty: 3,
        startDate: "2025-08-01",
        projectedEndDate: "2025-08-25",
        completedDate: "2025-08-22",
        assigneeId: "kenji-tanaka",
        blurb: "Verify both cores boot independently and can execute code from shared SRAM.",
        learningTopicIds: ["testbench-architecture"],
      },
      {
        phase: "verification",
        task: "Mailbox IPC tests",
        done: false,
        effort: 3,
        uncertainty: 4,
        startDate: "2025-09-15",
        projectedEndDate: "2025-10-15",
        assigneeId: "sarah-chen",
        blurb: "Test message passing between cores via mailbox with concurrent access and overflow scenarios.",
        learningTopicIds: ["testbench-architecture", "constrained-random"],
      },
      {
        phase: "synthesis",
        task: "Basic dual-core on FPGA",
        done: true,
        effort: 3,
        uncertainty: 3,
        ...
        assigneeId: "kenji-tanaka",
        blurb: "Deploy dual-core system to Arty A7-35T and verify basic operation of both processors.",
        learningTopicIds: ["synthesis-strategies"],
      },
      {
        phase: "synthesis",
        task: "Runtime task partitioning",
        done: false,
        effort: 4,
        uncertainty: 4,
        startDate: "2025-10-10",
        projectedEndDate: "2025-11-30",
        assigneeId: "kenji-tanaka",
        blurb: "Implement simple runtime that dynamically partitions workload between ARM and RISC-V cores.",
        learningTopicIds: ["synthesis-strategies"],
      },
    ],
  },
  {
    ...
    institution: "MIT",
    description:
      "An intelligent power management unit for the milliSoC that implements dynamic voltage and frequency scaling (DVFS) based on workload characterisation.",
    architecture:
      "Digital controller with lookup-table-based DVFS policy engine. Monitors core activity counters to make scaling decisions.",
    tags: ["Low Power", "Power Management", "milliSoC", "ASIC"],
    referenceSoc: "milliSoC",
    technology: "ASIC",
    status: "Planning",
    ...
    milestones: [
      {
        phase: "architecture",
        task: "Write PMU specification",
        done: true,
        effort: 3,
        uncertainty: 3,
        startDate: "2025-11-01",
        projectedEndDate: "2025-12-01",
        completedDate: "2025-11-28",
        assigneeId: "emily-watson",
        blurb: "Document DVFS operating points, activity counter interfaces, and power domain structure.",
        learningTopicIds: ["system-partitioning", "power-clocking"],
      },
      {
        phase: "architecture",
        task: "Define DVFS operating points",
        done: false,
        effort: 3,
        uncertainty: 4,
        ...
        assigneeId: "emily-watson",
        blurb:
          "Characterise voltage-frequency pairs for milliSoC and define lookup table entries for the policy engine.",
        learningTopicIds: ["power-clocking"],
      },
      {
        phase: "architecture",
        task: "Plan activity monitor counters",
        done: false,
        effort: 2,
        uncertainty: 3,
        startDate: "2026-01-10",
        projectedEndDate: "2026-02-10",
        assigneeId: "emily-watson",
        blurb: "Select performance counters (IPC, cache miss rate, bus utilisation) and define sampling strategy.",
        learningTopicIds: ["system-partitioning"],
      },
      {
        phase: "rtl",
        task: "Implement policy engine",
        done: false,
        effort: 4,
        uncertainty: 3,
        startDate: "2026-02-15",
        projectedEndDate: "2026-03-30",
        assigneeId: "emily-watson",
        blurb: "LUT-based decision logic mapping activity profiles to optimal voltage/frequency operating points.",
        learningTopicIds: ["fsm-design", "coding-style"],
      },
      {
        phase: "rtl",
        task: "Implement clock manager",
        done: false,
        effort: 4,
        uncertainty: 3,
        ...
        assigneeId: "emily-watson",
        blurb: "Glitch-free clock switching with programmable divider ratios and smooth transition logic.",
        learningTopicIds: ["coding-style", "power-clocking"],
      },
      {
        phase: "rtl",
        task: "Implement voltage controller SPI",
        done: false,
        effort: 3,
        uncertainty: 2,
        ...
        assigneeId: "emily-watson",
        blurb: "SPI master interface for controlling external PMIC voltage regulators with sequencing logic.",
        learningTopicIds: ["interface-protocols", "coding-style"],
      },
    ],
  },
...
export const technologies = [
  ...
  // ── Components > Peripherals ──
  {
    ...
    links: [{ label: "ARM CMSDK Peripherals", url: "https://developer.arm.com/Tools%20and%20Software/Corstone-101" }],
  },
  ...
  // ── Components > Memory Controllers ──
  {
    ...
    description: "On-chip SRAM blocks and memory controller IP for interfacing with external memories in SoC designs.",
    longDescription:
  ...
  // ── Components > Hardware Acceleration ──
  {
    ...
    links: [{ label: "SoC Labs Accelerator Guide", url: "https://git.soton.ac.uk/soclabs/accelerator-project" }],
  },
  ...
  // ── EDA Tooling > RTL Design ──
  {
    ...
    links: [{ label: "Verilator", url: "https://www.veripool.org/verilator/" }],
  },
  ...
  },
  {
    ...
    links: [{ label: "Yosys GitHub", url: "https://github.com/YosysHQ/yosys" }],
  },
  {
  ...
  // ── EDA Tooling > Physical Design ──
  {
    ...
    links: [{ label: "OpenROAD", url: "https://openroad.readthedocs.io/" }],
  },
  {
    id: "innovus-icc2",
    name: "Innovus / ICC2",
  ...
  // ── EDA Tooling > Tapeout ──
  {
    ...
    links: [{ label: "Siemens Calibre", url: "https://eda.sw.siemens.com/en-US/ic/calibre/" }],
  },
  ...
  // ── EDA Tooling > Silicon Validation ──
  {
    ...
    links: [
      { label: "OpenOCD", url: "https://openocd.org/" },
      {
        ...
        url: "https://developer.arm.com/Tools%20and%20Software/Arm%20Development%20Studio",
      },
    ],
  },
  ...
  // ── Infrastructure > FPGA Boards ──
  {
    ...
    description: "Prototyping boards from Xilinx/AMD and Intel/Altera used for SoC validation before ASIC fabrication.",
    longDescription:
...
export const partners = [
  ...
  },
  {
    ...
    longDescription:
      "MIT's Energy-Efficient Circuits group develops adaptive power management techniques for always-on IoT devices. Their work on dynamic voltage and frequency scaling (DVFS) controllers for the milliSoC platform targets 40-60% energy reduction for typical IoT workloads.",
  ...
  },
  {
    ...
    longDescription:
      "IIT Bombay's VLSI group focuses on on-chip communication architectures and SoC integration. Their research on high-performance bus interconnects and communication interfaces contributes critical infrastructure IP to the milliSoC platform.",
  ...
  },
  {
    ...
    longDescription:
      "TU Munich's Chair of Integrated Systems focuses on safety-critical hardware design for automotive applications. Their work on certified safety controllers based on the milliSoC targets ISO 26262 compliance for autonomous vehicle subsystems.",
