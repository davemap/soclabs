...
export const communityProjects = [
  {
    ...
    milestones: [
      ...
      { phase: "synthesis", task: "Logic synthesis with timing constraints", done: true, effort: 3, uncertainty: 2, startDate: "2025-09-10", projectedEndDate: "2025-09-30", completedDate: "2025-09-28", assigneeId: "sarah-chen", blurb: "Synthesise for 100 MHz target on Artix-7. Resolve timing violations in MAC array critical paths." },
      { phase: "synthesis", task: "Area and power analysis", done: true, effort: 2, uncertainty: 1, startDate: "2025-09-25", projectedEndDate: "2025-10-10", completedDate: "2025-10-08", assigneeId: "sarah-chen", blurb: "Generate area and power reports. MAC array uses ~3,200 LUTs. Dynamic power within FPGA budget." },
      { phase: "fpga", task: "Synthesise for Arty A7", done: true, effort: 3, uncertainty: 2, startDate: "2025-10-05", projectedEndDate: "2025-10-25", completedDate: "2025-10-22", assigneeId: "sarah-chen", blurb: "FPGA-specific synthesis, place & route, and bitstream generation for the Digilent Arty A7-35T board." },
      { phase: "fpga", task: "Run inference benchmark on hardware", done: false, effort: 3, uncertainty: 3, startDate: "2025-10-20", projectedEndDate: "2025-11-15", assigneeId: "kenji-tanaka", blurb: "Execute MobileNet-v1 inference on real hardware and measure latency, throughput, and power consumption." },
      { phase: "fpga", task: "Optimise clock frequency", done: false, effort: 4, uncertainty: 4, startDate: "2025-11-10", projectedEndDate: "2025-12-10", assigneeId: "sarah-chen", blurb: "Push clock frequency beyond 100 MHz through pipeline balancing and critical path optimisation." },
      { phase: "asic", task: "Select shuttle service", done: false, effort: 2, uncertainty: 3, startDate: "2026-01-10", projectedEndDate: "2026-02-10", assigneeId: "sarah-chen", blurb: "Evaluate Europractice, MOSIS, and Google/Skywater shuttles for cost, turnaround, and technology node." },
      { phase: "asic", task: "Physical design flow", done: false, effort: 5, uncertainty: 4, startDate: "2026-02-15", projectedEndDate: "2026-05-15", assigneeId: "sarah-chen", blurb: "Complete physical design including floorplanning, placement, clock tree synthesis, routing, and sign-off checks." },
  ...
  },
  {
    ...
    milestones: [
      ...
      { phase: "synthesis", task: "Timing sign-off", done: true, effort: 3, uncertainty: 2, startDate: "2025-07-05", projectedEndDate: "2025-07-25", completedDate: "2025-07-22", assigneeId: "james-okonkwo", blurb: "Static timing analysis across all corners. Fix setup/hold violations in S-Box paths." },
      { phase: "fpga", task: "FPGA prototype validation", done: true, effort: 3, uncertainty: 2, startDate: "2025-07-20", projectedEndDate: "2025-08-15", completedDate: "2025-08-10", assigneeId: "james-okonkwo", blurb: "Validate crypto engine functionality on FPGA before committing to ASIC tapeout." },
      { phase: "asic", task: "Physical design complete", done: true, effort: 5, uncertainty: 3, startDate: "2025-08-10", projectedEndDate: "2025-09-20", completedDate: "2025-09-18", assigneeId: "james-okonkwo", blurb: "Floorplanning, placement, CTS, and routing for TSMC 65nm. Target area under 15 kGE." },
      { phase: "asic", task: "DRC/LVS sign-off", done: true, effort: 3, uncertainty: 2, startDate: "2025-09-15", projectedEndDate: "2025-10-05", completedDate: "2025-10-02", assigneeId: "james-okonkwo", blurb: "Pass all design rule checks and layout-vs-schematic verification for foundry submission." },
      { phase: "asic", task: "Submit to Europractice shuttle", done: false, effort: 2, uncertainty: 3, startDate: "2025-10-01", projectedEndDate: "2025-10-30", assigneeId: "james-okonkwo", blurb: "Prepare GDS-II, submit to Europractice MPW shuttle, and handle foundry interface requirements." },
  ...
  },
  {
    ...
    milestones: [
      ...
      { phase: "fpga", task: "FIR path running on Arty A7", done: true, effort: 3, uncertainty: 2, startDate: "2025-05-01", projectedEndDate: "2025-05-20", completedDate: "2025-05-18", assigneeId: "maria-gonzalez", blurb: "Deploy FIR-only configuration to Arty A7 FPGA and validate with real audio input signals." },
      { phase: "fpga", task: "Full filter bank on FPGA", done: false, effort: 3, uncertainty: 3, startDate: "2025-06-15", projectedEndDate: "2025-07-15", assigneeId: "maria-gonzalez", blurb: "Complete FPGA deployment with both FIR and IIR paths, all 8 channels, and runtime reconfiguration." },
    ],
  },
  {
    ...
    milestones: [
      ...
      { phase: "fpga", task: "Basic dual-core on FPGA", done: true, effort: 3, uncertainty: 3, startDate: "2025-09-01", projectedEndDate: "2025-09-30", completedDate: "2025-10-05", assigneeId: "kenji-tanaka", blurb: "Deploy dual-core system to Arty A7-35T and verify basic operation of both processors." },
      { phase: "fpga", task: "Runtime task partitioning", done: false, effort: 4, uncertainty: 4, startDate: "2025-10-10", projectedEndDate: "2025-11-30", assigneeId: "kenji-tanaka", blurb: "Implement simple runtime that dynamically partitions workload between ARM and RISC-V cores." },
    ],
  },
  {
    id: "power-management",
