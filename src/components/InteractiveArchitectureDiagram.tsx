...
const typeColors: Record<string, { bg: string; border: string; text: string }> = {
  ...
  dma: { bg: "bg-indigo-50 dark:bg-indigo-500/10", border: "border-indigo-200 dark:border-indigo-500/30", text: "text-indigo-600 dark:text-indigo-400" },
  ...
  interconnect: { bg: "bg-sky-50 dark:bg-sky-500/10", border: "border-sky-200 dark:border-sky-500/30", text: "text-sky-600 dark:text-sky-400" },
...
const InteractiveArchitectureDiagram = ({ blocks, designName }: InteractiveArchitectureDiagramProps) => {
  ...
  const BusArrow = () => (
    <div className="flex flex-col items-center py-1">
      <svg width="16" height="28" viewBox="0 0 16 28" className="text-sky-300 dark:text-sky-500/60">
              ...
              <div className="rounded-xl border-2 border-dashed border-amber-300 dark:border-amber-500/30 bg-amber-50/50 dark:bg-amber-500/5 p-4">
                ...
                <button
                  ...
                  className={`
                    ...
                    bg-white dark:bg-card border-sky-200 dark:border-sky-500/30 text-sky-600 dark:text-sky-400
